...
CREATE TABLE SpotifyClone.Historico(
    ...
    date_reproduction VARCHAR(100) NOT NULL,
...
INSERT INTO SpotifyClone.Planos (tipo, plano_value)
VALUES
  ('gratuito', 0),
  ('familiar', 7.99),
  ('universitário', 5.99),
...
INSERT INTO SpotifyClone.Usuario (usuario_name, idade, data_assinatura, plano_id)
VALUES
...
INSERT INTO SpotifyClone.Album (album_name, ano_lancamento, artista_id)
VALUES
  ('Envious', '1990', 1),
  ('Exuberant', '1993', 1),
...
INSERT INTO SpotifyClone.Historico (usuario_id, date_reproduction, cancoes_id)
VALUES
